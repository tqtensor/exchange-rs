...
mod tests {
    ...
    fn build_signed_request() {
        ...
        let parameters: BTreeMap<String, String> = BTreeMap::new();
        let result =
            exchange::util::build_signed_request_custom(parameters, recv_window, now).unwrap();
    ...
    fn to_i64() {
        ...
        assert_eq!(exchange::util::to_i64(&value_max), i64::MAX);
        assert_eq!(exchange::util::to_i64(&value_min), i64::MIN);
    }
