...
mod tests {
    ...
    use float_cmp::*;
    use exchange::account::OrderSide;
    use exchange::futures::model::Transaction;
    ...
    fn change_initial_leverage() {
        ...
        let account: FuturesAccount = Exchange::new_with_config(None, None, &config);
